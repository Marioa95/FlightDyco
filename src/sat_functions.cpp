...
//This file contains the functions to calculate the dynamics of a satellite
// def_massproperties()
// forces()
// moments()
// 
...
Matrixop Satellite::dwdt(Matrixop I, Matrixop M, Matrixop w, Matrixop dI) {
...
void Satellite::omega_calc(Matrixop wo, Matrixop qo,Matrixop Mo, double h, double tf) {
